# pylint: disable=fixme,missing-docstring,c-extension-no-member
import json
import os
...
def from_existing_clustering(filepath) -> List[IntangibleSubgraph]:
    ''' I just modified the original method to return a dict mapping 
    from index to clustering.
    '''
    ...
    with open(filepath, encoding='utf8') as f:
        for line in f:
            ...
            clusters \
                .setdefault(cluster_id, IntangibleSubgraph([], cluster_id)) \
                .subset \
                .append(int(node_id))
...
def main(
    ...
    if len(universal_before) > 0:
        ...
        output_entries = []
        with open(universal_before, encoding='utf8') as json_file:
